        ...
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <a href="#" className="flex items-center gap-2 text-xs text-muted-foreground hover:text-primary transition-colors duration-500">
                <Instagram size={12} /> @rayadiamonds
              </a>
            </div>
          </div>
        </div>
